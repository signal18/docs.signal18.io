...
## 8.3.1 SBOM and EU Cyber Resilience Act
...
## 8.3.2 The Cyber Resilience Act
...
### 8.3.2.2 Open-source software and the CRA
...
## 8.3.3 Software Bill of Materials
...
### 8.3.3.4 Generating the SBOM locally
...
## 8.3.4 Using the SBOM

### 8.3.4.1 Vulnerability scanning
...
### 8.3.4.2 Software composition analysis
...
## 8.3.5 Vulnerability Disclosure

### 8.3.5.1 Reporting a vulnerability
