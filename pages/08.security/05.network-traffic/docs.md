...
## 8.5.2 Internal Cluster Traffic
...
## 8.5.3 Outbound Traffic to Signal18 Cloud Services
...
### 8.5.3.2 GitLab (Backoffice SSO and Config Sync)
...
### 8.5.3.3 Signal18 Meet (Alert Forwarding)
...
## 8.5.4 Summary — Outbound Rules for Cloud18
