...
## 8.2.1 Process User and Privilege Drop
...
## 8.2.2 Configuration File Security
...
## 8.2.3 API Security Configuration
...
## 8.2.4 Database Security Configuration
...
## 8.2.5 Vault Security Configuration
...
### 8.2.5.3 Rotation of Database Credentials
