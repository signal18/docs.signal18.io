...
## 6.3.1 Logs and Troubleshooting
...
## 6.3.2 replication-manager Daemon Log
...
### 6.3.2.1 Typical log-level guide
...
## 6.3.3 Per-Cluster Diagnostic Files
...
## 6.3.5 Common Troubleshooting Steps

### 6.3.5.1 Replication-manager won't connect to a server
...
### 6.3.5.2 Failover triggered unexpectedly
...
### 6.3.5.3 Alert firing but no notification received

1. Verify the error code is in `monitoring-alert-trigger` (see [Alerting Configuration Guide](../../09.alerting/01.configuration-guide))
