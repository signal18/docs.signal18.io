...
## 6.2.4.1 Basic Performance Schema Monitoring
...
## 6.2.4.3 Latch (RWLock) Wait Monitoring
...
## 6.2.4.4 Performance Schema Memory Monitoring
...
## 6.2.4.7 Performance Considerations
...
## 6.2.4.8 Database Configuration
