...
## 6.1.2 What the Monitor Tracks

### 6.1.2.1 Replication topology
...
### 6.1.2.3 Schema and data consistency
...
### 6.1.2.4 Security and compliance
...
## 6.1.4 Accessing Monitoring Data
...
| Schema monitoring and data checksumming | [Schema and Data Checks](../../07.maintenance/01.configuration-guide/03.schema-data-checks) |
| Alert channels and triggers | [Alerting](../../09.alerting) |
