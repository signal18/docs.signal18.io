...
### 6.2.3.1.1 How Collection Works
...
### 6.2.3.1.2 Enabling the Scheduler
...
### 6.2.3.1.5 Special Case: Shard Proxy
...
### 6.2.3.1.6 Persisting the Table Dictionary
...
### 6.2.3.2.1 Triggering a Checksum
...
### 6.2.3.2.2 How Checksumming Works
...
### 6.2.3.2.4 Excluding Expected Divergence
...
### 6.2.3.2.5 Supported Primary Key Types
...
## 6.2.3.3 Repairing Divergent Tables
...
## 6.2.3.4 GUI: Shards and Schema Graph
...
## 6.2.3.5 Failover Policy and Data Divergence

### 6.2.3.5.1 How Divergence Affects Replica Election
...
### 6.2.3.5.2 Controlling Failover Behaviour
...
### 6.2.3.5.3 Recommended Workflow for Strict Mode
