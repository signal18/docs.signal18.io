...
## 10.3.2 Three-Layer Config System
...
### 10.3.2.1 01_preserved.cnf — Server-specific locked values
...
### 10.3.2.2 02_delta.cnf — Calculated drift
...
### 10.3.2.3 03_agreed.cnf — Manually accepted deviations
...
## 10.3.3 Cluster-Wide Preserved Variables
...
## 10.3.5 Monitoring Config Changes
...
## 10.3.6 Reading Variables from Config Files
