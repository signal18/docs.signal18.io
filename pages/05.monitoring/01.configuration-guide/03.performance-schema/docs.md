...
## 5.2.4.1 Basic Performance Schema Monitoring
...
## 5.2.4.3 Latch (RWLock) Wait Monitoring
...
## 5.2.4.4 Performance Schema Memory Monitoring
...
## 5.2.4.8 Database Configuration
