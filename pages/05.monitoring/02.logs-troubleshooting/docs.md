...
## 5.3.1 Logs and Troubleshooting
...
## 5.3.2 replication-manager Daemon Log
...
### 5.3.2.1 Typical log-level guide
...
## 5.3.3 Per-Cluster Diagnostic Files
...
## 5.3.5 Common Troubleshooting Steps

### 5.3.5.1 Replication-manager won't connect to a server
...
### 5.3.5.2 Failover triggered unexpectedly
...
### 5.3.5.3 Alert firing but no notification received
