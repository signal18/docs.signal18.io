...
## 7.2.3.1 Schema Monitoring

### 7.2.3.1.1 How Collection Works
...
### 7.2.3.1.2 Enabling the Scheduler
...
### 7.2.3.1.5 Special Case: Shard Proxy
...
### 7.2.3.1.6 Persisting the Table Dictionary
...
### 7.2.3.2.2 How Checksumming Works
...
### 7.2.3.2.4 Excluding Expected Divergence
...
### 7.2.3.2.5 Supported Primary Key Types
...
## 7.2.3.3 Repairing Divergent Tables
...
## 7.2.3.4 GUI: Shards and Schema Graph
...
## 7.2.3.5 Failover Policy and Data Divergence

### 7.2.3.5.1 How Divergence Affects Replica Election
...
### 7.2.3.5.2 Controlling Failover Behaviour
...
### 7.2.3.5.3 Recommended Workflow for Strict Mode
