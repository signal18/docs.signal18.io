...
## 2.1.14.1 Pre-Migration Checklist
...
## 2.1.14.2 Major Changes in 3.x

### 2.1.14.2.1 Configuration File Location Changes
...
### 2.1.14.2.2 Docker Volume Mapping Changes
...
## 2.1.14.3 Deprecated Parameters
...
### 2.1.14.3.2 Migration Script for Deprecated Parameters
...
## 2.1.14.4 Default Value Changes
...
## 2.1.14.5 New Features Requiring Configuration

### 2.1.14.5.1 Active-Passive Topology (3.1)
...
### 2.1.14.5.2 Enhanced Backup Management (3.1)
...
### 2.1.14.5.3 Transaction Monitoring (3.1)
...
### 2.1.14.5.4 Per-Module Log Levels (3.1)
...
## 2.1.14.6 Breaking Changes

### 2.1.14.6.1 API Changes
...
### 2.1.14.6.2 SSL/TLS Mode Changes
...
### 2.1.14.6.3 Backup Tool Changes
...
## 2.1.14.7 Migration Procedure

### 2.1.14.7.1 Step 1: Prepare Environment
...
### 2.1.14.7.2 Step 2: Update Configuration Files
...
### 2.1.14.7.3 Step 3: Install replication-manager 3.x
...
### 2.1.14.7.4 Step 4: Verify Configuration
...
### 2.1.14.7.5 Step 5: Start and Validate
...
### 2.1.14.7.6 Step 6: Monitor for Issues
...
## 2.1.14.8 Post-Migration Tasks

### 2.1.14.8.1 Update Backup Scripts
...
### 2.1.14.8.3 Documentation Updates
...
## 2.1.14.10 Troubleshooting

### 2.1.14.10.1 Configuration Not Loading
...
### 2.1.14.10.2 Deprecated Parameter Warnings
...
### 2.1.14.10.3 Performance Schema Overhead
...
### 2.1.14.10.4 Docker Container Not Persisting Config
...
### 2.1.14.10.5 Backup Tools Not Found
...
### 2.1.14.12.4 Upgrading from 3.0 to 3.1
