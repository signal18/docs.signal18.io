...
For the full-screen NOC-style slideshow that cycles through all monitored clusters, see the dedicated [Cluster Slideshow](/monitoring/slideshow) page in the Monitoring section.
