...
## Viewing Logs on a Modern Linux System

### journalctl — follow in real time
...
### journalctl — search inside messages
...
## Accessing Logs via the REST API
