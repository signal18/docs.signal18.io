...
## 2. What Registration Provides

### 2.1 Community Plugin Access
...
### 2.2 Configuration Backup and Restore
...
#### 2.2.1 Starting fresh from GitLab
...
### 2.3 Cluster Role Sharing with External Users
...
#### 2.3.3 External partner lifecycle
...
### 2.4 Direct Chat with Signal18 and Partners
...
### 2.5 Cloud18 Marketplace Participation
