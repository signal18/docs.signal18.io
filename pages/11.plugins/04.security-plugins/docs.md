...
### SEC0103 — require_secure_transport=OFF
...
### SEC0107 — Anonymous user account
...
### SEC0108 — Wildcard-host privileged user
...
### SEC0109 / SEC0110 / SEC0111 — At-rest encryption (via plugin-score-encryption)
...
### SEC0112 — Audit logging not active
...
### SEC0113 / SEC0114 / SEC0115 — Password validation plugins *(MariaDB only)*
