...
### 10.3.1.8.1 On-Premise Database Provisioning Scripts
...
### 10.3.1.8.2 Proxy Provisioning Scripts
...
### 10.3.1.8.4 Provisioning Hook Scripts
...
### 10.3.1.8.5 Failover and Replication Hook Scripts
...
### 10.3.1.8.6 Monitoring Hook Scripts
...
### 10.3.1.8.7 Backup Hook Scripts
...
### 10.3.1.8.8 Staging and Cloud Scripts
...
### 10.3.1.8.9 On-Premise SSH Script Overrides
...
### 10.3.1.8.1 On-Premise Provisioning Scripts
...
### 10.3.1.8.3 Container Bootstrap

| Script | Purpose |
|---|---|
| `opensvc/bootstrap` | OpenSVC init container bootstrap |

### 10.3.1.8.4 Maintenance Scripts
